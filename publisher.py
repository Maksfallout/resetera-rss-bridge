...
ПРАВИЛА ФОРМЫ:
5. Объём ТЕКСТА (без заголовка): от 300 до 700 знаков, целевой объём — около 500.
6. Заголовок: краткий, до 100 знаков, на русском, цепляющий, без англицизмов.
7. Стиль — разговорный, живой, как будто рассказываешь другу. Не «согласно сообщениям», а «оказывается» / «представь себе» / «вот что выяснилось».
8. Эмодзи — ровно 1 или 2 на пост (в тексте), к месту.
9. НЕ добавляй: ссылки, хештеги, призывы подписаться, «ставьте лайки», «пишите в комментариях».
10. НЕ начинай текст со штампов: «Сегодня...», «На днях...», «Стало известно, что...», «Как сообщает...».
11. Если в исходнике мусор (меню, формы подписки, навигация) — игнорируй, бери только суть.

Текст исходной новости:
{article_text}

Верни ответ СТРОГО в формате JSON, без других слов, без markdown-обёрток:
{{"title": "русский заголовок", "text": "русский текст поста"}}"""
